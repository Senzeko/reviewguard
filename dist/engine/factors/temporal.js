 ...
 */
export function computeTemporalScore(reviewPublishedAt, transactionClosedAt) {
    const deltaMs = Math.abs(reviewPublishedAt.getTime() - transactionClosedAt.getTime());
