 ...
 * comparison.
 */
export function jaroWinkler(raw1, raw2) {
...
export function computeIdentityScore(reviewerName, customerName) {
    // If name_plain_temp has expired (customerName is null):
    if (customerName === null) {
        return {
            score: 0.0,
            level: 'NO_DATA',
            detail: 'Identity match unavailable \u2014 plaintext name window has expired (>14 days)',
