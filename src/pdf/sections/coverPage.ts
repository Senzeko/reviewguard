...
export function renderCoverPage(
  ...
  ctx.y = drawText(
    ctx.page,
    'REPUTATION AUDIT: EVIDENCE OF POLICY VIOLATION',
    MARGIN,
    ctx.y,
    { font: ctx.fonts.bold, size: FONT_SIZES.h1, color: COLORS.navy },
  );
  ...
  if (packet.llmInferenceFlag) {
    const warningText =
      'One or more findings in this report were generated using LLM-based ' +
