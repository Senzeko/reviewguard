...
import type { ReviewGuardJob, QueueName } from '../queue/jobs.js';
...
const QUEUE_ORDER: QueueName[] = ['REVIEWS', 'POS_SYNC', 'SCHEDULED', 'PDF'];
...
async function dispatch(job: ReviewGuardJob): Promise<void> {
  switch (job.type) {
